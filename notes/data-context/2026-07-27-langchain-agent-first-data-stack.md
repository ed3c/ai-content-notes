...
path: "notes/data-context/2026-07-27-langchain-agent-first-data-stack.md"
migration:
  from_repository: ed3c/openwiki-ablation
  from_path: "ai-content-notes/notes/data-context/2026-07-27-langchain-agent-first-data-stack.md"
...
- **影子證據**：文章以 `account_status` 為例，明確定義 `Active`、`Churned`、`Prospect`，並要求 customer reporting 預設 filter `Active`。  
- **連結**：→ [[C1]], [[P1]]
