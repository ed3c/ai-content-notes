...
path: "notes/ai-science/2026-07-21-xaira-causal-models-causal-data.md"
migration:
  from_repository: ed3c/openwiki-ablation
  from_path: "ai-content-notes/notes/ai-science/2026-07-21-xaira-causal-models-causal-data.md"
...
- **漏洞利用 (Exploit/How)**：  
  ...
  4. 若 `train_improves=true && test_slope≈0`，建立 `information_limited` flag。  
