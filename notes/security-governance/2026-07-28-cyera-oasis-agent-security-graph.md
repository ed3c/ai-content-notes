...
path: "notes/security-governance/2026-07-28-cyera-oasis-agent-security-graph.md"
migration:
  from_repository: ed3c/openwiki-ablation
  from_path: "ai-content-notes/notes/security-governance/2026-07-28-cyera-oasis-agent-security-graph.md"
...
- **漏洞利用 (Exploit/How)**：  
  ...
  3. Agent runtime 每次 tool call 寫入 `agent_id / session_id / credential_id / action / resource / timestamp`。  
