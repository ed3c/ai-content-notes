...
path: "notes/security-governance/2026-08-07-openai-frontier-cyber-capability-governance.md"
migration:
  from_repository: ed3c/openwiki-ablation
  from_path: "ai-content-notes/notes/security-governance/2026-08-07-openai-frontier-cyber-capability-governance.md"
...
- **漏洞利用 (Exploit/How)**：  
  ...
  4. tool calls 寫 structured audit log：agent_id、tool、arguments、destination、authorization decision、result hash。  
