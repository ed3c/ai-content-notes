...
category: "open-model-supply-chain"
language: zh-TW
note_format: zettelkasten-v6.6-cyberpunk
storage: private-github-markdown
repository: ed3c/ai-content-notes
path: "notes/open-model-supply-chain/2026-07-24-americas-open-model-paradox.md"
migration:
  from_repository: ed3c/openwiki-ablation
  from_path: "ai-content-notes/notes/open-model-supply-chain/2026-07-24-americas-open-model-paradox.md"
...
- **具體條款/機制**：  
  - `model_id + revision + provider + license + geography + checksum`。  
  - Synthetic example 記 `teacher_model`, `generation_date`, `prompt_version`, `temperature`, `review_status`。  
