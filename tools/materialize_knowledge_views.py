...
def main() -> int:
    ...
    parser.add_argument("--plan-schema", type=Path, default=Path("schemas/projection-plan-v2.schema.json"))
    parser.add_argument("--bundle-schema", type=Path, default=Path("schemas/projection-bundle-v2.schema.json"))
