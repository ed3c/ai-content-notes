...
- **Shadow Evidence**：[[EV-cvrngaqzq3y-stage-ship]] `00:00:44–00:01:17`；[[EV-cvrngaqzq3y-stage-collect]] `00:01:17–00:01:47`；[[EV-cvrngaqzq3y-stage-mine-experiment]] `00:01:47–00:02:17`。
- **Outcome**：SOURCE_REPORTED；來源未提供可直接檢查的 benchmark output。
...
- **Typed Links**：FLOW → [[N-autonomy-trace-mining]] · FLOW → [[P-trace-driven-improvement-cycle]] · FLOW → [[C-model-harness-task-fit]]
