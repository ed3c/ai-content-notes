...
- Daily completed note writes follow the repository's atomic direct-to-`main` operating rule.
- Schema, governance, exporter, security, migration, and cross-repository contract changes use a branch/PR unless explicitly directed otherwise.
- Any license, security, interface, behavior, or freshness change must emit downstream impact and requalification signals without changing Skill lifecycle locally.
